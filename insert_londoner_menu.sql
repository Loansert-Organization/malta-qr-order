-- Complete menu insertion for The Londoner British Pub Sliema
-- This script uses the correct schema and properly escapes all quotes

-- First ensure vendor and menu exist for the bar
DO $$
DECLARE
    v_bar_id UUID;
    v_vendor_id UUID;
