...
// Manual bar data with realistic Malta information and correct PostgreSQL point format
const BARS_DATA = [
  {
    name: 'Aqualuna Lido',
    ...
    rating: 4.2,
    review_count: 156,
    location_gps: { lat: 35.9125, lng: 14.5024 },
  ...
  },
  {
    ...
    rating: 4.5,
    review_count: 89,
    location_gps: { lat: 35.8989, lng: 14.5144 },
  ...
  },
  {
    ...
    rating: 4.3,
    review_count: 178,
    location_gps: { lat: 35.9224, lng: 14.4884 },
  ...
  },
  {
    ...
    rating: 4.1,
    review_count: 89,
    location_gps: { lat: 35.9024, lng: 14.4864 },
  ...
  },
  {
    ...
    rating: 4.4,
    review_count: 123,
    location_gps: { lat: 35.8894, lng: 14.5324 },
  ...
  },
  {
    ...
    rating: 4.3,
    review_count: 198,
    location_gps: { lat: 35.8624, lng: 14.5664 },
...
// Main execution
async function main() {
  console.log('🚀 Starting Bar Onboarding Process (Final Version)');
  console.log('==================================================');
  ...
  console.log(`📍 Correct PostgreSQL point format`);
  console.log('');
